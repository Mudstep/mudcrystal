...
MapGroup_Cerulean:
	...
	map Route24, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_24, MUSIC_ROUTE_25, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route25, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_25, MUSIC_ROUTE_25, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Fuchsia:
	...
	map BillsOlderSistersHouse, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
